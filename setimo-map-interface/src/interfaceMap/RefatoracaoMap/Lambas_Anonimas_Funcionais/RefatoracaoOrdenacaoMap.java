...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
        ...
        //Ordenação de nome contato com a utilização de Lambda
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(Comparator.comparing(
        		   cont -> cont.getValue().getNumero()));       
        
        
        //Ordenacao de número de telefone pelo metodo estático do comparator, o método compare  
        /*
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(Comparator.comparing(
		...
		*/
        ...
        //Ordenacao de número de telefone por função anônima
        /*
        ...
        */
        ...
        //Ordenação com a utilização da classe ComparatorOrdemNumerica comentada ao fim desse código:
        ...
        //Ordenação de nome contato com a utilização da classe ComparatorOrdemNomeContato comentada ao fim desse código:
        // Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(new ComparatorOrdemNomeContato()); 
        
      //Ordenacao de nome contato por função anônima;
      /*  Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(new Comparator<Map.Entry<Integer, Contato>>(){
       ...
       //Ordenacao de nome pelo contato metodo estático do comparator,o método Compare:
